...
q7 = do
    let nestedList =
            List [Elem 1, List [Elem 2, List [Elem 3, Elem 4], Elem 5]] :: NestedList Int
...
q8 :: IO ()
q8 = print $ compress "aaaabccaadeeee"
...
q9 :: IO ()
q9 = print $ pack ['a', 'a', 'a', 'a', 'b', 'c', 'c', 'a', 'a', 'd', 'e', 'e']
...
q10 :: IO ()
q10 = print $ encode "aaaabccaadeeee"
...
q11 :: IO ()
q11 = print $ encodeMod "aaaabccaadeeee"
...
dupli :: [a] -> [a]
dupli [] = []
dupli xs = foldr (\x -> (++) [x, x]) [] xs

q14 :: IO ()
q14 = print $ dupli ([1 .. 5] :: [Int])
...
q15 :: IO ()
q15 = print $ repli "abc" 3

dropNth :: [a] -> Int -> [a]
dropNth xs n = [x | (x, i) <- zip xs ([1 ..] :: [Int]), mod i n /= 0]

q16 :: IO ()
q16 = print $ dropNth "abcdefghik" 3
...
q18 :: IO ()
q18 = print $ slice ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'k'] 3 7
